...
# Netweaver SVPC with network Submodule

This module is handles opinionated Netweaver SVPC with Network configuration and deployment.
...
- Create a 2 Persistent Disks to host Netweaver's File systems
...
module "gcp_netweaver_svpc_with_network" {
  source                 = "../../modules/netweaver_svpc_with_network"
