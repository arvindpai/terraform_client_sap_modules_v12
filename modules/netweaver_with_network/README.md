...
# Netweaver with network Submodule

This module is handles opinionated Netweaver with Network configuration and deployment.
...
module "gcp_netweaver_with_network" {
  source                 = "terraform-google-modules/sap/google/modules/netweaver_with_network"
