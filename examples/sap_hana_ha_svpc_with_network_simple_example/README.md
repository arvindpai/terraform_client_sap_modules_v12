# SAP HANA HA SVPC with Network Simple Example

This example illustrates how to use the `SAP HANA HA SVPC with Network` submodule to deploy SAP HANA HA on GCP.
